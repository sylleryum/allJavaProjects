...
public class HATEOASBuilder{
     ...
     */
    public static void linksBuilder (HATEOASBuilder entity, Class<? extends HATEOASController> ControllerClass, String rel){

        List<Link> linksList = new ArrayList<>();
        linksList.add(linkTo(methodOn(ControllerClass).findById(entity.getId())).withSelfRel());
        linksList.add(linkTo(methodOn(ControllerClass).findAll(null)).withRel(rel));
    ...
    public static void linksBuilderNestedEntity(List<? extends HATEOASBuilder> entity, Class<? extends HATEOASController> ControllerClass, String rel){
        ...
        entity.forEach(i-> {
            ...
            linksList.add(linkTo(methodOn(ControllerClass).findById(i.getId())).withSelfRel());
            linksList.add(linkTo(methodOn(ControllerClass).findAll(null)).withRel(rel));
