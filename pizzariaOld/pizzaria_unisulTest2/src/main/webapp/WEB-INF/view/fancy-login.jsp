...
<body>
	...
	<div>
	<h3>Bem vindo ao sistema de pedido da Pizzaria X</h3>
		...
		<div id="loginbox" style="margin-top: 50px;"
			...
			<div class="panel panel-info">
				...
				<div style="padding-top: 30px" class="panel-body">
					...
					<a href="${pageContext.request.contextPath}/register">Não tem cadastro? Registre-se</a>
